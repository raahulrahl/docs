...
response = requests.get("http://agent:8030/agent/skills")
...
for skill in nlp_skills:
    details = requests.get(
        f"http://agent:8030/agent/skills/{skill['id']}"
    ).json()
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub Examples" icon="github" href="https://github.com/Saptha-me/Bindu/tree/main/examples/skills">
    View example skills
  </Card>
</CardGroup>
...
- **[Skills System Docs](https://github.com/Saptha-me/Bindu/blob/main/docs/skills-system.md)** - Complete technical documentation
- **[Example Skills](https://github.com/Saptha-me/Bindu/tree/main/examples/skills)** - Real-world skill definitions
