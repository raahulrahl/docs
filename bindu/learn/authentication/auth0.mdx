...
<CardGroup cols={2}>
  ...
  <Card title="Client Examples" icon="code" href="https://github.com/Saptha-me/Bindu/tree/main/examples">
...
- **[GitHub Examples](https://github.com/Saptha-me/Bindu/tree/main/examples)** - Complete working examples
