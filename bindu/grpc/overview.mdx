...
| `UnregisterAgent` | "I am shutting down. Clean up." Reserved for SDKs that implement graceful shutdown — the current TypeScript SDK does not call this; it relies on heartbeat timeout instead. |
...
<AccordionGroup>
  <Accordion title="mTLS supported, off by default">
    ...
    rollout is the gating piece. See `docs/MTLS_DEPLOYMENT_GUIDE.md` for the deployment story.
  </Accordion>
