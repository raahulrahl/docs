...
🚀 Bindu Server 🚀
Agent Server: http://localhost:8030
...
Protocol Endpoints:
  - A2A: http://localhost:8030/a2a
  - DID Resolution: http://localhost:8030/did/resolve
  - Agent Info: http://localhost:8030/agent/info
...
INFO:     Uvicorn running on http://localhost:8030 (Press CTRL+C to quit)
```
...
Visit `http://localhost:8030/agent/info` to see your agent's complete AgentCard.