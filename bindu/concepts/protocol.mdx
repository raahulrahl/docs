...
- **A2A Protocol Endpoint** - Standard agent-to-agent communication at `POST /`
- **DID Resolution** - Discover and verify agent identities
- **Agent Card** - Capability and metadata discovery at `/.well-known/agent.json`

Visit `http://localhost:3773/.well-known/agent.json` to see your agent's complete AgentCard.