...
The fastest way to get started is using our cookiecutter template:

<AccordionGroup>
  <Accordion icon="cookie-bite" title="Use Cookiecutter Template (Recommended)">
    Create a new Pebbling project using our template:
    ```bash
    uv tool run cookiecutter https://github.com/Pebbling-ai/cookiecutter-pebbling
    ```
    
    Follow the interactive prompts:
    ```
    [1/4] name (pebble_project): my_agent
    [2/4] description (): My first Pebbling agent
    ...
    After creation, navigate to your project and set it up:
    ```bash
    cd my_agent
    ...
    🐧 Penguine ID: ba23326c671c4c96a6613c9ef34f169e
    ```
  </Accordion>
</AccordionGroup>
